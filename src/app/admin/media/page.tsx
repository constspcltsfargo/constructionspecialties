...
export default function GalleryPage() {
    ...
    const handleUpload = async (files: FileList) => {
        ...
        // Dedicate to gallery, so no folder path is needed.
        formData.append('folderPath', 'gallery');
            ...
            <CardHeader>
                <div className="flex justify-between items-center flex-wrap gap-4">
                    <div>
                        ...
                        <CardDescription>Upload, view, and manage photos for your website's gallery.</CardDescription>
                    </div>
                    <div className="flex gap-2 flex-wrap justify-end">
                        <Button onClick={() => fileInputRef.current?.click()} disabled={isUploading}>
                            {isUploading ? <><span className="animate-spin mr-2">...</span> Uploading...</> : <><Upload className="mr-2 h-4 w-4" /> Upload Photos</>}
                        </Button>
                        <input
                            type="file"
                            ref={fileInputRef}
            ...
            <CardContent>
                            ...
                            <Card key={item.id} className="group relative overflow-hidden">
                                ...
                                <div className="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center gap-2 p-2">
                                    ...
                                    <AlertDialogContent>
                                        ...
                                        <AlertDialogDescription>This will permanently delete the photo. This action cannot be undone.</AlertDialogDescription>
                                        </AlertDialogHeader>
                                        <AlertDialogFooter>
                ...
                {media && media.length === 0 && !isLoading && (
                     <div className="text-center py-12 border-2 border-dashed rounded-lg">
                        ...
                        <p className="text-muted-foreground mt-2">Click "Upload Photos" to add to your gallery.</p>
                    </div>
                )}
            </CardContent>
        </Card>
